...
OLLAMA_INTENT_ROUTER_MODEL = "gpt-oss:20b-cloudb"
OLLAMA_STATE_EXTRACTOR_MODEL = "gpt-oss:20b-cloud"
OLLAMA_MEMORY_EXTRACTOR_MODEL = "gpt-oss:20b-cloud"
OLLAMA_ITEM_AGENT_MODEL = "gpt-oss:20b-cloud"
OLLAMA_QUEST_AGENT_MODEL = "gpt-oss:20b-cloud"
OLLAMA_MUSIC_CLASSIFIER = "gpt-oss:20b-cloud"